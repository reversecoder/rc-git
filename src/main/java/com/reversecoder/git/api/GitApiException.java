...
public abstract class GitApiException extends Exception {
    ...
    /**
     * Constructs a new GitApiException with the specified detail message. The
     ...
     */
    public GitApiException(final String message, final Throwable cause) {
        super(message);
        initCause(cause);
    }

    /**
     * Constructs a new GitApiException with the specified detail message and
     * cause.
     *
     * @param message
     *            - the detail message (which is saved for later retrieval by
     *            the getMessage() method).
     */
    public GitApiException(final String message) {
        super(message);
    }

    /**
     * Returns the cause of this throwable or null if the cause is nonexistent
     * or unknown. (The cause is the throwable that caused this exception to get
     * thrown.)
     *
     ...
     * cause is the throwable that caused this throwable to get thrown.) This
     ...
     * throwable was created with GitApiException(Throwable) or
     * GitApiException(String,Throwable), this method cannot be called even once.
     *
