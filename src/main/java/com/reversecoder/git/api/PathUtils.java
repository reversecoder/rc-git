...
public final class PathUtils {
     ...
     * input <code>http://www.codehause.org</code> this method will return
    ...
    public static int port(String url) {
        ...
        if (protocol == null || protocol.equalsIgnoreCase("file")) {
            return GitApiConstants.UNKNOWN_PORT;
        }
        ...
        if (url.regionMatches(true, 0, "file:", 0, 5)
                || url.regionMatches(true, 0, "local:", 0, 6)) {
            return GitApiConstants.UNKNOWN_PORT;
        }
        ...
        if (protocol.equalsIgnoreCase("file")) {
            ...
            if (retValue.startsWith("//")) {
                ...
                if (retValue.length() >= 2
                        && (retValue.charAt(1) == '|' || retValue.charAt(1) == ':')) {
                    // special case: if there is a windows drive letter, then
            ...
            // special case: if there is a windows drive letter using |, switch
            // to :
     ...
     * decoder assumes that ISO-8859-1 is used to convert URL-encoded octets to
     * characters.
     * 
     * @param url
